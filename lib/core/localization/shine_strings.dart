...
class ShineStrings {
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'cart_added_qty': 'Added {count} to cart',
      'no_reviews_yet_message': 'No reviews yet. Be the first to review this product.',
    ...
    'ar': {
      ...
      'back': 'رجوع',
      'failed_to_load_product': 'فشل تحميل المنتج',
      ...
      'cart_added_qty': 'تمت إضافة {count} إلى السلة',
      'no_reviews_yet_message': 'لا توجد تقييمات بعد. كُن أول من يقيّم هذا المنتج.',
      'write_review': 'اكتب تقييماً',
      'login_to_review': 'سجّل الدخول للتقييم',
