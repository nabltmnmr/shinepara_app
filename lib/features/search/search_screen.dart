...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  final List<String> _recent = ['Night Cream', 'Vitamin C Serum', 'Moisturizer'];
  final List<String> _topBrands = const ['Olay', 'Estée', 'Lume', 'Chanel', 'Dior', 'Clinique'];
