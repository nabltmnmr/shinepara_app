...
class CartScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final shipping = cartItems.isEmpty ? 0.0 : 12.0;
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Text('Shop Now', style: AppTextStyles.buttonText),
                                  ),
                                ),
                              ],
                            ),
...
class _TotalsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          _SummaryRow(label: 'Subtotal', value: money.format(subtotal), valueColor: AppColors.white),
          const SizedBox(height: 14),
          _SummaryRow(label: 'Shipping', value: money.format(shipping), valueColor: AppColors.white),
          const SizedBox(height: 16),
